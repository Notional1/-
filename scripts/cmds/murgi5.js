...
a("তোর সানি আব্বুর চুদা লো");
setTimeout(() => {a({body: "আমি সানি করলাম শুরু তোর মার পুটকিতে ডুকামু ২টা গরু গরু নাকি ডাকে হাম্বা  তোর মার ভোদায় ডুকামু ২টা ইলেক্ট্রিকের খাম্বা 🥰।" + " " + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a("~ সানির থেকে চুদা কি আরো খাবি মাগির পোল 🤖")} , 39000);
...
setTimeout(() => {a({body: "Hi Sany এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi Sany এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~ বস সানি এর ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
