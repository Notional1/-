...
module.exports = {
  ...
  onReply: async function ({ api, event, Reply }) {
    ...
    if (event.type == "message_reply") {
      ...
      if (reply === 1) {
        query = "funny";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗙𝘂𝗻𝗻𝘆 𝘃𝗶𝗱𝗲𝗼 <🤣🗼";
      } else if (reply === 2) {
        query = "islamic";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗜𝘀𝗹𝗮𝗺𝗶𝗰 𝘃𝗶𝗱𝗲𝗼 <😇🩸";
      } else if (reply === 3) {
        query = "sad";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗦𝗮𝗱 𝘃𝗶𝗱𝗲𝗼 <🥺🫰";
      } else if (reply === 4) {
        query = "anime";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗮𝗻𝗶𝗺 𝘃𝗶𝗱𝗲𝗼 <😘💧";
      } else if (reply === 5) {
        query = "video";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗖𝗮𝗿𝘁𝗼𝗼𝗻 𝘃𝗶𝗱𝗲𝗼 <😇🎋";
      } else if (reply === 6) {
        query = "lofi";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗟𝗼𝗳𝗶 𝘃𝗶𝗱𝗲𝗼 <😇✨";
      } else if (reply === 7 && event.senderID === admin) {
        query = "horny";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗛𝗼𝗿𝗻𝘆 𝘃𝗶𝗱𝗲𝗼 <🥵🎎";
      } else if (reply === 8) {
        query = "love";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗟𝗼𝘃𝗲 𝘃𝗶𝗱𝗲𝗼 <😍🎗️";
      } else if (reply === 9) {
        query = "baby";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗖𝘂𝘁𝗲 𝗕𝗮𝗯𝘆 𝘃𝗶𝗱𝗲𝗼 <🧑‍🍼💊";
      } else if (reply === 10) {
        query = "photo";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗥𝗮𝗻𝗱𝗼𝗺 𝗣𝗵𝗼𝘁𝗼 <😙♻️";
      } else if (reply === 11) {
        query = "aesthetic";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗔𝗲𝘀𝘁𝗵𝗲𝘁𝗶𝗰 𝗩𝗶𝗱𝗲𝗼 <😙⚜️";
      } else if (reply === 12) {
        query = "sigma";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗦𝗶𝗴𝗺𝗮 𝘃𝗶𝗱𝗲𝗼 <🐤♀🌾";
      } else if (reply === 13) {
        query = "lyrics";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗟𝘆𝗿𝗶𝗰𝘀 𝘃𝗶𝗱𝗲𝗼 <🥰";
      } else if (reply === 14) {
        query = "cat";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗖𝗮𝘁 𝗩𝗶𝗱𝗲𝗼 <😙🌿";
      } else if (reply === 15 && event.senderID === admin) {
        query = "sex";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗦𝗲𝘅 𝘃𝗶𝗱𝗲𝗼 <😙🌻";
      } else if (reply === 16) {
        query = "ff";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗙𝗿𝗲𝗲 𝗙𝗶𝗿𝗲 𝗩𝗶𝗱𝗲𝗼 <😙🪄";
      } else if (reply === 17) {
        query = "football";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗙𝗼𝗼𝘁𝗯𝗮𝗹𝗹 𝘃𝗶𝗱𝗲𝗼<😙🪁";
      } else if (reply === 18) {
        query = "girl";
        cp = "🪄𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗚𝗶𝗿𝗹 𝘃𝗶𝗱𝗲𝗼<😙🧨";
      } else if (reply === 19) {
        query = "friend";
        cp = "☄️𝗡𝗮𝘄 𝗕𝗮𝗯𝘆 𝗙𝗿𝗶𝗲𝗻𝗱𝘀 𝘃𝗶𝗱𝗲𝗼<😙🎈";
